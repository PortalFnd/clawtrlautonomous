...
```bash
git clone https://github.com/portalfnd/clawtrlautonomous
cd clawtrlautonomous && ./claw
```
...
```
https://raw.githubusercontent.com/portalfnd/clawtrlautonomous/main/articles/feed.xml
```
