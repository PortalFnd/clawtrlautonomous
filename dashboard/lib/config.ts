...
/**
 * Parse claw.yml into a typed config object.
 */
export function parseConfig(raw: string): ClawConfig {
...
/**
 * Update a skill's config fields in claw.yml. Preserves formatting and comments.
 */
...
/**
 * Remove a skill entry from claw.yml.
 */
...
/**
 * Add a new skill entry to claw.yml (before the fallback comment).
 */
