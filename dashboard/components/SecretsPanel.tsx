  ...
  return (
    <div className="max-w-2xl mx-auto space-y-[var(--space-lg)]">
      <div>
        ...
        <p className="text-[12px] text-primary-40 font-mono mt-1">API keys, channel tokens, and provider endpoints. Stored as GitHub Secrets, never written to the repo.</p>
      </div>
      {['Model Providers', 'Core', 'Telegram', 'Discord', 'Slack', 'Email', 'Distribution', 'Skill Keys'].map(group => {
